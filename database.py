...
list_movie = [
    {
        ...
        "sold_seat": {
            "bsd": {
                "today": {
                    "time1": [[False for j in range(15)] for i in range(9)],
                    "time2": [[False for j in range(15)] for i in range(9)],
                    "time3": [[False for j in range(15)] for i in range(9)],
                    "time4": [[False for j in range(15)] for i in range(9)],
                    },
                "tomorrow": {
                    "time1": [[False for j in range(15)] for i in range(9)],
                    "time2": [[False for j in range(15)] for i in range(9)],
